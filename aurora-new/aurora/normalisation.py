...
def normalise_atmos_var(
    ...
    for level in atmos_levels:
        if stats and f"{name}_{level}" in stats:
            location, scale = stats[f"{name}_{level}"]
        else:
            location = locations[f"{name}_{level}"]
            scale = scales[f"{name}_{level}"]

        level_locations.append(location)
...
locations: dict[str, float] = {
    ...
    "10v": 1.891580e-01,
    "msl": 1.009578e05,
    "tp": 1.9351341724395752,
    "tciwv": 14.829245567321777,
    "z_50": 1.993730e05,
    "z_100": 1.576421e05,
    "z_150": 1.331414e05,
    "z_200": 1.153300e05,
...
scales: dict[str, float] = {
    ...
    "10v": 4.765339e00,
    "msl": 1.332246e03,
    "tp": 4.5509724617004395,
    "tciwv": 8.00402545928955,
    "z_50": 5.875553e03,
    "z_100": 5.510640e03,
    "z_150": 5.823912e03,
    "z_200": 5.820169e03,
