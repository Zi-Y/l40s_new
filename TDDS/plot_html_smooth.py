...
for base_name in selected_labels:
    ...
    mean_curve_smooth = gaussian_filter1d(mean_curve, sigma=2)
    std_curve_smooth = gaussian_filter1d(std_curve, sigma=2)
...
# Save as HTML
pio.write_html(fig, "/home/zi/research_project/TDDS/interactive_plot.html")
