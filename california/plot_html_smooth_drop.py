...
# pr_values = [0.3, 0.5, 0.7,]  # pr 值（在每个方法内部按此顺序排序）
...
for pm in pm_values:
    for pr in pr_values:
        ...
        all_seed_data = []
        for seed in seeds:
            file_path = f"./results_california_data_pruning_singlePR_new/drop_new/pm_{pm}/pr_{int(pr * 100)}/results_seed{seed}_pr{pr}_pm{pm}_metric_epoch30_metric_seed0.npy"
...
# Save as HTML
output_path = "/home/zi/research_project/california/random_interactive_plot_drop_new.html"
