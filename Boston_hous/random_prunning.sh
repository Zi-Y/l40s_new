...
SCRIPT_PATH="/home/zi/research_project/Boston_hous/boston_random_pruning_singlePR.py"
...
do
    ...
    CUDA_VISIBLE_DEVICES="$GPU_ID" python "$SCRIPT_PATH" --pruning_rate "$PRUNING_RATE" &
