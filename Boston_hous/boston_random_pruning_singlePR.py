...
def run_multiple_seeds(base_train_dataset, test_loader, best_params, config, device, seeds=10):
    ...
    for epoch, avg_loss in enumerate(avg_test_losses, start=1):
        wandb.log({"Iteration": epoch*2, "Avg Test Loss": avg_loss})
...
def main():
    ...
    parser.add_argument('--iterations', type=int, default=150, help='Number of training iterations')
    ...
    parser.add_argument('--hidden_layers', type=int, nargs='+', default=[64, 64], help='Sizes of hidden layers')
    parser.add_argument('--wandb_project', type=str, default='boston-prediction', help='WandB project name')
