...
# years = range(2009, 2022) if not args.years else [int(y) for y in args.years.split(',')]
years = range(2008, 2009) if not args.years else [int(y) for y in args.years.split(',')]
for year in years:
