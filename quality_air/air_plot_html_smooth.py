...
for pm in pm_values:
    ...
    for pr in pr_values:
        ...
        for seed in seeds:
            ...
            # /home/local/zi/research_project/quality_air/results_air_data_pruning_singlePR_new/drop/pm_-1
...
# Save as HTML
output_path = "/home/local/zi/research_project/quality_air/random_air_interactive_plot_drop_new.html"
