...
def main():
    ...
    parser.add_argument('--wandb_project', type=str,
                        ...
                        default='air-quality-prediction', help='WandB project name')
    ...
    if 'boston' in args.wandb_project:
    ...
    elif 'air' in args.wandb_project:
        # 数据集准备
        def get_air_quality_dataset(file_path="AirQualityUCI.csv"):
            if not os.path.exists(file_path):
                raise FileNotFoundError(
                    f"Dataset file not found at {file_path}. Please download and extract it manually.")
            return file_path
