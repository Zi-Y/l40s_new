...
SCRIPT_PATH="/home/local/zi/research_project/quality_air/air_random_pruning_singlePR.py"
...
#    fi
    ...
    CUDA_VISIBLE_DEVICES="$GPU_ID" python "$SCRIPT_PATH" --wandb_project air-quality-fixed --seeds 60 --pruning_rate "$PRUNING_RATE" &
